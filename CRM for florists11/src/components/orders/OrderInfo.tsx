      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            {isEditing ? (
              <Textarea
                value={editableData?.postcard || order.postcard || ''}
                onChange={(e) => handleChange('postcard', e.target.value)}
              ...
              <div className="mt-1 p-3 bg-gray-50 rounded-md">
                <p className="text-sm">{order.postcard || 'Не указан'}</p>
              </div>
            )}
          </div>
        ...
        <div className="md:col-span-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <Label>Сумма</Label>
              <div className="mt-1 p-3 bg-gray-50 rounded-md">
                <p className="text-sm">{order.payment.amount.toLocaleString()} ₸</p>
              </div>
            </div>
            <div>
              <Label>Статус</Label>
